...
int main(void)
{
    ...
    // Create the Semaphore used to control the RGB LED on the MKII
    Sem_MKII_RGB = xSemaphoreCreateBinary();

    // Create the Semaphore used to control the RGB LED on the Launchpad
    Sem_LAUNCHPAD_RGB = xSemaphoreCreateBinary();

    // Give the Semaphore for the UART
